<template>
    <div class="project__numbers" :style="{ backgroundImage: background_image }">
        <div class="container">
            <div class="row">
                <div class="text text-center col-lg-12 col-sm-12">
                    <h2 v-if="title" v-html="title"></h2>
                    <h3 v-if="subtitle" v-html="subtitle"></h3>
                    <div class="list row">
                        <div class="item col-lg-3 col-md-4 col-xs-12" v-for="block in blocks" v-if="blocks">
                            <div class="heading">
