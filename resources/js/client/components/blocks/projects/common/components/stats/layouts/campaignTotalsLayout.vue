                ...
                <div class="inner" v-if="tableData">
                    <div class="table">
                        <div class="table__head" v-if="tableData.heading">
                            <span v-for="item in tableData.heading" :style="labelsStyles">{{ item.title }}</span>
                        </div>
                    ...
                    <div class="caption">
                        ...
                        <small v-if="tableData.caption_subtitle" :style="labelsStyles">{{ tableData.caption_subtitle }}</small>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            image: function () {
                return objGet(this.data, 'bottom_image');
            },
            tableData: function () {
                if (!objHas(this.data, 'bottom_block_table.heading') || !objHas(this.data, 'bottom_block_table.rows')) {
                    return {};
                }

                try {
                    let data = this.data.bottom_block_table;
