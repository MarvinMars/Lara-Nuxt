                            ...
                            <form class="form-horizontal" role="form" method="POST"
                                ...
                                <div class="auth-body">
                                    ...
                                    <div class="form-group"
                                        ...
                                        <div v-if="veeErrors.has('password')" class="form-control-feedback" v-cloak>@{{
                                    ...
                                    <div class="form-group"
                                        ...
                                        <div v-if="veeErrors.has('password_confirmation')" class="form-control-feedback"
                                             v-cloak>@{{ veeErrors.first('password_confirmation') }}
                                        </div>
